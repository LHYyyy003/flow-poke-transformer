...
class DinoV3HF(nn.Module):
    ...
    def __init__(
        ...
        # Set MYRIAD_DINO_PATH to use a locally downloaded compatible DINOv3
        # snapshot (for example a ModelScope snapshot) without contacting HF.
        local_model_path = os.environ.get("MYRIAD_DINO_PATH")
        backbone = AutoModel.from_pretrained(
            local_model_path or model_version,
